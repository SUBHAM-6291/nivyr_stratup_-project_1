    ...
    <footer className="bg-[#1a1a1a] text-white font-josefin" style={{ fontFamily: 'Josefin Sans, sans-serif' }}>
      <div className="flex flex-col max-w-[1920px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row min-h-[400px]">
          ...
          <div
            className="bg-[#373737] pt-0 pb-0 pl-8 pr-8 flex flex-col w-full md:w-[clamp(100px,30%,400px)] min-h-full"
          >
            <Image
            ...
            />
            <h2 className="text-2xl font-bold mb-3 self-center">TaLa Prattoy</h2>
            <p className="text-sm mb-3 text-gray-300 self-start">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
            <div className="w-full flex flex-col flex-grow">
              <h3 className="text-lg font-semibold mb-3 self-start">Join Newsletter</h3>
